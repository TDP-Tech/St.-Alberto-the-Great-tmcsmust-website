...
class KarismatikiMemberTransaction(models.Model):
    member = models.ForeignKey(TmcsMember, on_delete=models.CASCADE, related_name='karismatikiTransactions', verbose_name='Member Unique Identifier')
    ...
    class Meta:
        verbose_name = 'Karismatiki Malipo ya Ada'
        verbose_name_plural = 'Karismatiki Malipo ya Ada'
