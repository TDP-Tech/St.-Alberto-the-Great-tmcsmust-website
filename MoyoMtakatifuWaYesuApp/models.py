...
class MoyomtakatifuwaYesuMemberTransaction(models.Model):
    member = models.ForeignKey(TmcsMember, on_delete=models.CASCADE, related_name='moyomtakatifuwaYesuTransactions', verbose_name='Member Unique Identifier')
